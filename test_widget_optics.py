...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.laser_dummy = LaserDeviceBase('dummy_001','wish','delusion')
        #laser_001 = LaserHorizontalWidget(self.laser_dummy,'dummy_001')
        laser_001 = LaserVerticalWidget(self.laser_dummy,'dummy_001')
        layout.addWidget(laser_001)
